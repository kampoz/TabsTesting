...
public class CustomizeBottomTabsView extends LinearLayout implements OnClickListener {
  ...
  public CustomizeBottomTabsView(Context context) {
    super(context);
    init();
  }
  ...
  private void init() {
    inflate(getContext(), R.layout.layout_tabs_bottom, this);
